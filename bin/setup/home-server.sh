...
aur -si --ignorearch rtl88xxau-aircrack-dkms-git nginx-mod-dav-ext apache-tools
sudo pacman -Sy cmus dnsmasq hostapd wireguard-dkms wireguard-tools jq crda

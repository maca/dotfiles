...
follow.style = s.sort(s.reverse(s.charset("asdfghjkl"))) -- home row
...
-- save downloads to custom folder
downloads.default_dir = "/secondary/Downloads"
...
downloads.add_signal("download-location", function (uri, file)
    ...
    if string.match(file, ".torrent$") then
        return downloads.default_dir .. "/torrent/files/" .. file 
